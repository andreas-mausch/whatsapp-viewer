...
ChatControlMessageWithPreview::ChatControlMessageWithPreview(WhatsappMessage &message, HFONT dateFont, ImageDecoder &imageDecoder)
	: ChatControlMessage(message, dateFont)
{
